...
<div class="flex justify-center items-center min-h-screen p-4">
    <div class="bg-white shadow-md rounded-lg p-6 text-center w-full max-w-lg">
        ...
        <div class="flex flex-row sm:flex-row justify-center items-center gap-2 mb-4">
            ...
            <h1 class="text-xl font-medium text-dark font-serif text-center sm:text-center">Program Studi Teknik Informatika</h1>
        ...
        <h2 class="text-2xl font-bold text-white mb-2 tracking-wider [text-shadow:_10px_2px_12px_rgba(4,167,251,0.30)]">
            <span class="bg-gradient-to-r from-blue-700 to-[#075F8D] text-transparent bg-clip-text">SEMNASTI X 4U SECURITY</span>
        </h2>
        <!-- Keterangan -->
        <h1 class="mt-4">Dengan Tema:</h1>
        <h3 class="text-sm font-medium text-dark mb-8 tracking-wide  text-center">
            INDONESIA'S CYBER SECURITY CHALLENGE IN<br />
            BUILDING A ROBUST DEFENSE
        </h3>

        <p class="text-sm text-dark leading-relaxed mt-4  text-center">
